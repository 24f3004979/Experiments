...
Power of fetch API calls, 
        Designed as complte interface for restfull api 
        + Idempotent -> Multiple delte request = one request 
...
Q : Why Lifecycle hooks are not Async 
    Its strictly made with being syncronous loading
    + Impacts component render due to usual component strict requirements
    + Loading Data prior to execution for straight loading is required for handeling component life cycle smooth execution
